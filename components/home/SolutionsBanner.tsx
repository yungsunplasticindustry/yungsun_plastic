      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center text-white max-w-4xl mx-auto">
          ...
          <p className="text-xl mb-8 text-zinc-100">
            Pakistan&apos;s leading supplier for food, dairy, cosmetics, and industrial manufacturing plants.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/products">
              <Button size="lg" className="bg-yellow-600 hover:bg-yellow-700 text-white border-yellow-600 min-w-[200px]">
                Explore Solutions
              </Button>
            </Link>
            <Link href="/contact">
