        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-6">
              <Link href={COMPANY_INFO.social.facebook} target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-zinc-700 rounded-full flex items-center justify-center hover:bg-yellow-600 hover:text-white transition-colors" aria-label="Facebook">
                <Facebook className="h-4 w-4" />
              </Link>
              <Link href={COMPANY_INFO.social.instagram} target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-zinc-700 rounded-full flex items-center justify-center hover:bg-yellow-600 hover:text-white transition-colors" aria-label="Instagram">
              ...
              <Link href={COMPANY_INFO.social.youtube} target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-zinc-700 rounded-full flex items-center justify-center hover:bg-red-600 hover:text-white transition-colors" aria-label="YouTube">
                <Youtube className="h-4 w-4" />
              </Link>
              <Link href={COMPANY_INFO.social.google} target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-zinc-700 rounded-full flex items-center justify-center hover:bg-yellow-600 hover:text-white transition-colors" aria-label="Google Maps">
                <MapPin className="h-4 w-4" />
              </Link>
            </div>
          </div>
